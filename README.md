...
It also works with MicroPython's FrameBuffer class and the SSD1306. Just be sure to use a format of <code>framebuf.MONO_HLSB</code> when initializing the frame buffer or else your bitmaps will be sideways or worse.
